...
/* ================= TOOLS ================= */
 ...
 {"id":"tool-exiftool","updated":"2026-07","cat":"Tools","team":"blue","title":"ExifTool","desc":"Reads/writes metadata (EXIF/IPTC/XMP) across images, documents, and media; core forensics/OSINT utility (winget id OliverBetz.ExifTool).","url":"https://exiftool.org","license":"Artistic-1.0-or-GPL-1.0-or-later","platforms":["windows","macos","linux"],"tags":["forensics","osint","tools"],"install":{"cmd":"winget install OliverBetz.ExifTool","mac":"brew install exiftool","linux":"sudo apt install libimage-exiftool-perl"}},
...
/* --- tool install + usage (added) --- */
 ...
 {"id":"tool-netdiscover","updated":"2026-07","cat":"Tools","title":"netdiscover","desc":"Active/passive ARP reconnaissance to find live hosts on a local segment.","url":"https://www.kali.org/tools/netdiscover/","license":"open source","platforms":["linux"],"tags":["recon","network","tools"],"install":{"linux":"sudo apt install netdiscover"}},
 {"id":"tool-fping","updated":"2026-07","cat":"Tools","title":"fping","desc":"Parallel ICMP sweeper that pings many hosts at once and reports which are alive.","url":"https://www.kali.org/tools/fping/","license":"open source","platforms":["linux","macos"],"tags":["recon","network","tools"],"install":{"linux":"sudo apt install fping","mac":"brew install fping"}},
 {"id":"tool-dnsrecon","updated":"2026-07","cat":"Tools","title":"dnsrecon","desc":"DNS enumeration tool: records, zone transfers, brute force, and reverse lookups.","url":"https://www.kali.org/tools/dnsrecon/","license":"open source","platforms":["linux"],"tags":["recon","dns","tools"],"install":{"linux":"sudo apt install dnsrecon"}},
 {"id":"tool-dnsenum","updated":"2026-07","cat":"Tools","title":"dnsenum","desc":"Enumerate DNS info: hosts, records, MX, zone transfers, and subdomain brute force.","url":"https://www.kali.org/tools/dnsenum/","license":"open source","platforms":["linux"],"tags":["recon","dns","subdomain","tools"],"install":{"linux":"sudo apt install dnsenum"}},
 {"id":"tool-fierce","updated":"2026-07","cat":"Tools","title":"fierce","desc":"DNS reconnaissance and subdomain scanner for locating non-contiguous IP space.","url":"https://www.kali.org/tools/fierce/","license":"open source","platforms":["linux"],"tags":["recon","dns","subdomain","tools"],"install":{"linux":"sudo apt install fierce"}},
 {"id":"tool-sublist3r","updated":"2026-07","cat":"Tools","title":"Sublist3r","desc":"Passive subdomain enumeration using public search engines and OSINT sources.","url":"https://www.kali.org/tools/sublist3r/","license":"open source","platforms":["linux"],"tags":["recon","subdomain","osint","tools"],"install":{"linux":"sudo apt install sublist3r"}},
 ...
 {"id":"tool-wfuzz","updated":"2026-07","cat":"Tools","title":"wfuzz","desc":"Web application fuzzer for content discovery, parameters, and injection points.","url":"https://www.kali.org/tools/wfuzz/","license":"open source","platforms":["linux"],"tags":["web","enumeration","tools"],"install":{"linux":"sudo apt install wfuzz"}},
 {"id":"tool-commix","updated":"2026-07","cat":"Tools","title":"commix","desc":"Automated command-injection detection and exploitation tool.","url":"https://www.kali.org/tools/commix/","license":"open source","platforms":["linux"],"tags":["web","exploitation","tools"],"install":{"linux":"sudo apt install commix"}},
 ...
 {"id":"tool-bettercap","updated":"2026-07","cat":"Tools","title":"bettercap","desc":"Swiss-army knife for network recon and MITM (ARP/DNS spoofing, sniffing, proxies).","url":"https://www.kali.org/tools/bettercap/","license":"open source","platforms":["linux"],"tags":["network","tools"],"install":{"linux":"sudo apt install bettercap"}},
 {"id":"tool-ettercap","updated":"2026-07","cat":"Tools","title":"ettercap","desc":"Suite for man-in-the-middle attacks on a LAN (ARP poisoning, sniffing, filtering).","url":"https://www.kali.org/tools/ettercap/","license":"open source","platforms":["linux"],"tags":["network","tools"],"install":{"linux":"sudo apt install ettercap-text-only"}},
 {"id":"tool-mitmproxy","updated":"2026-07","cat":"Tools","title":"mitmproxy","desc":"Interactive TLS-capable intercepting HTTP(S) proxy with a CLI and scripting API.","url":"https://www.kali.org/tools/mitmproxy/","license":"open source","platforms":["linux","macos"],"tags":["web","network","tools"],"install":{"linux":"sudo apt install mitmproxy","mac":"brew install mitmproxy"}},
 {"id":"tool-msfvenom","updated":"2026-07","cat":"Tools","title":"msfvenom","desc":"Metasploit payload generator and encoder (part of metasploit-framework).","url":"https://www.kali.org/tools/metasploit-framework/","license":"open source","platforms":["linux"],"tags":["exploitation","tools"],"install":{"linux":"sudo apt install metasploit-framework"}},
 {"id":"tool-evil-winrm","updated":"2026-07","cat":"Tools","title":"evil-winrm","desc":"WinRM shell for Windows post-exploitation with upload/download and script loading.","url":"https://www.kali.org/tools/evil-winrm/","license":"open source","platforms":["linux"],"tags":["post-ex","remote","tools"],"install":{"linux":"sudo apt install evil-winrm"}},
 {"id":"tool-proxychains","updated":"2026-07","cat":"Tools","title":"proxychains-ng","desc":"Force TCP connections from any tool through SOCKS/HTTP proxies (pivoting).","url":"https://www.kali.org/tools/proxychains-ng/","license":"open source","platforms":["linux"],"tags":["post-ex","network","tools"],"install":{"linux":"sudo apt install proxychains4"}},
 {"id":"tool-socat","updated":"2026-07","cat":"Tools","title":"socat","desc":"Multipurpose relay: bidirectional byte streams between sockets, files, pipes, PTYs.","url":"https://www.kali.org/tools/socat/","license":"open source","platforms":["linux","macos"],"tags":["network","file-transfer","tools"],"install":{"linux":"sudo apt install socat","mac":"brew install socat"}},
 {"id":"tool-binwalk","updated":"2026-07","cat":"Tools","title":"binwalk","desc":"Firmware analysis: scan a binary for embedded files/filesystems and extract them.","url":"https://www.kali.org/tools/binwalk/","license":"open source","platforms":["linux","macos"],"tags":["forensics","tools"],"install":{"linux":"sudo apt install binwalk","mac":"brew install binwalk"}},
 {"id":"tool-foremost","updated":"2026-07","cat":"Tools","title":"foremost","desc":"Signature-based file carver that recovers files from disk images by header/footer.","url":"https://www.kali.org/tools/foremost/","license":"open source","platforms":["linux"],"tags":["forensics","recovery","tools"],"install":{"linux":"sudo apt install foremost"}},
 {"id":"tool-steghide","updated":"2026-07","cat":"Tools","title":"steghide","desc":"Steganography tool to embed/extract data hidden in JPEG/BMP/WAV/AU files.","url":"https://www.kali.org/tools/steghide/","license":"open source","platforms":["linux"],"tags":["forensics","tools"],"install":{"linux":"sudo apt install steghide"}},
 ...
 {"id":"tool-volatility3","updated":"2026-07","cat":"Tools","title":"Volatility 3","desc":"Advanced volatile-memory forensics framework for analyzing RAM dumps.","url":"https://www.kali.org/tools/volatility3/","license":"open source","platforms":["linux"],"tags":["forensics","memory","tools"],"install":{"linux":"sudo apt install volatility3"}},
 ...
 {"id":"tool-amass","updated":"2026-07","cat":"Tools","title":"amass","desc":"In-depth attack-surface mapping and subdomain enumeration (OWASP).","url":"https://www.kali.org/tools/amass/","license":"open source","platforms":["linux"],"tags":["recon","subdomain","osint","tools"],"install":{"linux":"sudo apt install amass"}},
 {"id":"tool-subfinder","updated":"2026-07","cat":"Tools","title":"subfinder","desc":"Fast passive subdomain discovery from many data sources (ProjectDiscovery).","url":"https://www.kali.org/tools/subfinder/","license":"open source","platforms":["linux"],"tags":["recon","subdomain","osint","tools"],"install":{"linux":"sudo apt install subfinder"}},
 {"id":"tool-theharvester","updated":"2026-07","cat":"Tools","title":"theHarvester","desc":"Gather emails, subdomains, hosts, and names from public OSINT sources.","url":"https://www.kali.org/tools/theharvester/","license":"open source","platforms":["linux"],"tags":["osint","recon","mail","tools"],"install":{"linux":"sudo apt install theharvester"}},
 {"id":"tool-whatweb","updated":"2026-07","cat":"Tools","title":"WhatWeb","desc":"Fingerprint web technologies, frameworks, servers, and versions.","url":"https://www.kali.org/tools/whatweb/","license":"open source","platforms":["linux"],"tags":["web","recon","tools"],"install":{"linux":"sudo apt install whatweb"}},
 {"id":"tool-wafw00f","updated":"2026-07","cat":"Tools","title":"wafw00f","desc":"Identify and fingerprint the Web Application Firewall in front of a site.","url":"https://www.kali.org/tools/wafw00f/","license":"open source","platforms":["linux"],"tags":["web","recon","tools"],"install":{"linux":"sudo apt install wafw00f"}},
 {"id":"tool-nbtscan","updated":"2026-07","cat":"Tools","title":"nbtscan","desc":"Scan networks for NetBIOS name information (names, shares, MACs).","url":"https://www.kali.org/tools/nbtscan/","license":"open source","platforms":["linux"],"tags":["recon","smb","network","tools"],"install":{"linux":"sudo apt install nbtscan"}},
 {"id":"tool-enum4linux-ng","updated":"2026-07","cat":"Tools","title":"enum4linux-ng","desc":"Modern SMB/Windows enumeration: users, shares, groups, policy (rewrite of enum4linux).","url":"https://www.kali.org/tools/enum4linux-ng/","license":"open source","platforms":["linux"],"tags":["recon","smb","enumeration","tools"],"install":{"linux":"sudo apt install enum4linux-ng"}},
 {"id":"tool-smbmap","updated":"2026-07","cat":"Tools","title":"smbmap","desc":"Enumerate SMB shares and permissions across a host or network, with file ops.","url":"https://www.kali.org/tools/smbmap/","license":"open source","platforms":["linux"],"tags":["recon","smb","enumeration","tools"],"install":{"linux":"sudo apt install smbmap"}},
 {"id":"tool-sslscan","updated":"2026-07","cat":"Tools","title":"sslscan","desc":"Query a server's supported SSL/TLS versions, ciphers, and certificate.","url":"https://www.kali.org/tools/sslscan/","license":"open source","platforms":["linux"],"tags":["tls","certificates","network","tools"],"install":{"linux":"sudo apt install sslscan"}},
 {"id":"tool-searchsploit","updated":"2026-07","cat":"Tools","title":"searchsploit (Exploit-DB)","desc":"Offline command-line search of the Exploit-DB archive of exploits and shellcode.","url":"https://www.kali.org/tools/exploitdb/","license":"open source","platforms":["linux"],"tags":["exploitation","reference","tools"],"install":{"linux":"sudo apt install exploitdb"}},
 {"id":"tool-gobuster","updated":"2026-07","cat":"Tools","title":"gobuster","desc":"Fast brute-forcer for directories, DNS subdomains, and virtual hosts.","url":"https://www.kali.org/tools/gobuster/","license":"open source","platforms":["linux"],"tags":["web","enumeration","tools"],"install":{"linux":"sudo apt install gobuster"}},
 {"id":"tool-feroxbuster","updated":"2026-07","cat":"Tools","title":"feroxbuster","desc":"Fast, recursive content discovery for web servers (Rust).","url":"https://www.kali.org/tools/feroxbuster/","license":"open source","platforms":["linux"],"tags":["web","enumeration","tools"],"install":{"linux":"sudo apt install feroxbuster"}},
 {"id":"tool-dirb","updated":"2026-07","cat":"Tools","title":"dirb","desc":"Classic web content scanner that brute-forces directories and files.","url":"https://www.kali.org/tools/dirb/","license":"open source","platforms":["linux"],"tags":["web","enumeration","tools"],"install":{"linux":"sudo apt install dirb"}},
 {"id":"tool-dalfox","updated":"2026-07","cat":"Tools","title":"dalfox","desc":"Fast, parameter-analysis-based XSS scanner and testing tool.","url":"https://www.kali.org/tools/dalfox/","license":"open source","platforms":["linux"],"tags":["web","exploitation","tools"],"install":{"linux":"sudo apt install dalfox"}},
 {"id":"tool-medusa","updated":"2026-07","cat":"Tools","title":"Medusa","desc":"Fast, parallel, modular login brute-forcer for many network protocols.","url":"https://www.kali.org/tools/medusa/","license":"open source","platforms":["linux"],"tags":["password","network","tools"],"install":{"linux":"sudo apt install medusa"}},
 {"id":"tool-ncrack","updated":"2026-07","cat":"Tools","title":"Ncrack","desc":"High-speed network authentication cracker from the Nmap project.","url":"https://www.kali.org/tools/ncrack/","license":"open source","platforms":["linux"],"tags":["password","network","tools"],"install":{"linux":"sudo apt install ncrack"}},
 {"id":"tool-crunch","updated":"2026-07","cat":"Tools","title":"crunch","desc":"Generate custom wordlists from a character set and pattern.","url":"https://www.kali.org/tools/crunch/","license":"open source","platforms":["linux"],"tags":["password","tools"],"install":{"linux":"sudo apt install crunch"}},
 {"id":"tool-cewl","updated":"2026-07","cat":"Tools","title":"CeWL","desc":"Spider a target site to build a custom wordlist from its content.","url":"https://www.kali.org/tools/cewl/","license":"open source","platforms":["linux"],"tags":["password","osint","tools"],"install":{"linux":"sudo apt install cewl"}},
 {"id":"tool-hashid","updated":"2026-07","cat":"Tools","title":"hashID","desc":"Identify the probable type(s) of a given hash.","url":"https://www.kali.org/tools/hashid/","license":"open source","platforms":["linux"],"tags":["password","tools"],"install":{"linux":"sudo apt install hashid"}},
 {"id":"tool-wifite","updated":"2026-07","cat":"Tools","title":"Wifite","desc":"Automated wireless auditor that wraps aircrack-ng, reaver, and hashcat.","url":"https://www.kali.org/tools/wifite/","license":"open source","platforms":["linux"],"tags":["wireless","tools"],"install":{"linux":"sudo apt install wifite"}},
 {"id":"tool-reaver","updated":"2026-07","cat":"Tools","title":"Reaver","desc":"Brute-force WPS PINs to recover WPA/WPA2 passphrases.","url":"https://www.kali.org/tools/reaver/","license":"open source","platforms":["linux"],"tags":["wireless","tools"],"install":{"linux":"sudo apt install reaver"}},
 ...
 {"id":"tool-hcxdumptool","updated":"2026-07","cat":"Tools","title":"hcxdumptool","desc":"Capture WPA PMKID/handshakes from Wi-Fi for offline cracking.","url":"https://www.kali.org/tools/hcxdumptool/","license":"open source","platforms":["linux"],"tags":["wireless","tools"],"install":{"linux":"sudo apt install hcxdumptool"}},
 ...
 {"id":"tool-responder","updated":"2026-07","cat":"Tools","title":"Responder","desc":"LLMNR/NBT-NS/MDNS poisoner that captures NetNTLM hashes; includes relay tooling.","url":"https://www.kali.org/tools/responder/","license":"open source","platforms":["linux"],"tags":["exploitation","network","active-directory","tools"],"install":{"linux":"sudo apt install responder"}},
 {"id":"tool-kerbrute","updated":"2026-07","cat":"Tools","title":"kerbrute","desc":"Fast Kerberos pre-auth username enumeration and password spraying.","url":"https://www.kali.org/tools/kerbrute/","license":"open source","platforms":["linux"],"tags":["password","active-directory","tools"],"install":{"linux":"sudo apt install kerbrute"}},
 {"id":"tool-smbclient","updated":"2026-07","cat":"Tools","title":"smbclient","desc":"FTP-like client for accessing SMB/CIFS shares (part of Samba).","url":"https://www.samba.org/","license":"open source","platforms":["linux"],"tags":["smb","enumeration","network","tools"],"install":{"linux":"sudo apt install smbclient"}},
 {"id":"tool-rpcclient","updated":"2026-07","cat":"Tools","title":"rpcclient","desc":"MS-RPC client for enumerating Windows/Samba (users, groups, shares) over RPC.","url":"https://www.samba.org/","license":"open source","platforms":["linux"],"tags":["smb","enumeration","active-directory","tools"],"install":{"linux":"sudo apt install smbclient"}},
 {"id":"tool-tshark","updated":"2026-07","cat":"Tools","title":"tshark (Wireshark CLI)","desc":"Command-line network protocol analyzer - capture and dissect packets like Wireshark.","url":"https://www.wireshark.org/","license":"open source","platforms":["linux"],"tags":["network","tools"],"install":{"linux":"sudo apt install tshark"}},
 {"id":"tool-netcat","updated":"2026-07","cat":"Tools","title":"netcat (nc)","desc":"The TCP/IP swiss-army knife: connect, listen, transfer data, and port-probe.","url":"https://www.kali.org/tools/netcat/","license":"open source","platforms":["linux"],"tags":["network","tools"],"install":{"linux":"sudo apt install netcat-traditional"}},
